...
<@requirement.PARAM name='LOG_LEVEL_ROOT' values='TRACE,DEBUG,INFO,WARN,ERROR' value='ERROR' type='select' />
...
<@img.TASK 'sc-gw-${namespace}' '172.25.6.89:8123/gateway:${PARAMS.TAG}'>
  ...
  <#if PARAMS.INVENTORY_URL?has_content>
    <@img.ENV 'INVENTORY_URL' PARAMS.INVENTORY_URL />
  </#if>
  <@img.ENV 'AUTH_MODE' PARAMS.AUTH_MODE />
