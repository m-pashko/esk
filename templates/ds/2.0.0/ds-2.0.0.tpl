...
<@requirement.PARAM name='JMX_PUBLISHED_PORT' required='false' value='1689' type='port' />
<@requirement.PARAM name='RMI_PUBLISHED_PORT' required='false' value='1690' type='port' />
...
<@img.TASK 'sc-ds-${namespace}' '172.25.6.89:8123/ds:${PARAMS.TAG}'> 
  ...
  <@img.PORT PARAMS.JMX_PUBLISHED_PORT PARAMS.JMX_PUBLISHED_PORT />
  <@img.PORT PARAMS.RMI_PUBLISHED_PORT PARAMS.RMI_PUBLISHED_PORT />
  ...
  <@img.ENV 'JMX_PORT' PARAMS.JMX_PUBLISHED_PORT />
  <@img.ENV 'RMI_PORT' PARAMS.RMI_PUBLISHED_PORT />
